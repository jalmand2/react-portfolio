                ...
                <div style={{justifyContent: 'flex-end'}}>
                    <div class="navbar-nav">
                        <ul style={{ listStyle: 'none', display: 'flex', alignItems: 'flex-end', marginRight: '5rem' }}>
                            <li  style={{ marginLeft: '10px', color: '#252323ff' }} onClick={showAbout}>About</li>
                            <li style={{ marginLeft: '10px', color: '#252323ff' }} onClick={showProjects}>Projects</li>
                            <li style={{ marginLeft: '10px', color: '#252323ff' }} onClick={showContact}>Contact</li>
                            <li style={{ marginLeft: '10px', color: '#252323ff' }} onClick={showResume}>Resume</li>
                        </ul>
                    </div>
                </div>
            </div>
